...
export const projects: Project[] = [
  {
    ...
    category: "Smart advertising screens",
    kind: "platform",
  ...
  },
  {
    id: "ebani",
    title: "Ebani",
    tagline: "The company behind those screens — hardware, software and support, all from one team.",
    category: "Digital screen network",
    kind: "web",
    role: "Flutter Developer @ Ebani Tech",
    organization: "Ebani Tech",
    period: "2026 — Present",
  ...
  },
  {
    id: "essonify",
    title: "Essonify",
    tagline: "A fashion app that remembers your whole wardrobe and suggests what to wear each day.",
    category: "Fashion & lifestyle app",
    kind: "mobile",
  ...
  },
  {
    id: "tajneed",
    title: "Tajneed",
    tagline: "The official app people use to apply to the U.A.E. Ministry of Defence.",
  ...
  },
  {
    id: "sadeeq-user",
    title: "Sadeeq",
    tagline: "Book a cleaner, plumber or electrician — vetted, fixed price, and you watch them arrive on the map.",
  ...
  },
  {
    ...
    tagline: "The companion app for the workers — their jobs for the day, their earnings, and chat with customers.",
    category: "App for service professionals",
    kind: "mobile",
    role: "Lead Flutter Developer",
    tier: 2,
    accent: "#b388ff",
  ...
  },
  {
    id: "riayah",
    title: "Riayah",
    tagline: "A hospital app for patients and appointments — rebuilt so it stops freezing on busy days.",
  ...
  },
  {
    ...
    tagline: "This website — the 3D, the animations and every page, designed and built by me.",
