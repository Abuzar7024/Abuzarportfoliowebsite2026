...
export const services = [
  { id: "flutter", Icon: Smartphone, title: "Flutter & React Native Apps", subtitle: "Cross-platform mobile", description: "High-performance Android and iOS apps from one codebase — Flutter or React Native — built on clean architecture and shipped to both stores.", features: ["Flutter apps", "React Native apps", "Enterprise mobile apps", "MVP development", "Firebase integration", "App Store & Play Store"], whatsappMsg: "Hi Abuzar, I visited your portfolio and I'm interested in Flutter App Development. Can we discuss my project?" },
  ...
  { id: "web", Icon: Globe, title: "Websites & Web Apps", subtitle: "React front-ends", description: "Modern React landing pages, dashboards and web applications with responsive, premium interfaces.", features: ["React web apps", "Landing pages", "Admin dashboards", "Interactive 3D experiences", "Progressive web apps"], whatsappMsg: "Hi Abuzar, I'd like to discuss a website development project with you." },
